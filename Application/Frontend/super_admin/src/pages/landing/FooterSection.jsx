        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '32px', marginBottom: '48px' }}>
          ...
          <div style={{ gridColumn: 'span 1' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', fontSize: '13px', color: '#CBD5E1', marginBottom: '20px' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <Mail size={14} color="#00B589" /> <a href="mailto:gatelink.in@gmail.com" style={{ color: '#CBD5E1', textDecoration: 'none' }}>gatelink.in@gmail.com</a>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/gatelink-technologies" target="_blank" rel="noreferrer" aria-label="LinkedIn" style={{ width: '32px', height: '32px', borderRadius: '4px', background: '#1E293B', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#FFFFFF' }}>
              ...
              {/* Twitter / X */}
              <a href="https://x.com/gatelinkin" target="_blank" rel="noreferrer" aria-label="X (formerly Twitter)" style={{ width: '32px', height: '32px', borderRadius: '4px', background: '#1E293B', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#FFFFFF' }}>
              ...
              {/* YouTube */}
              <a href="https://www.youtube.com/@GateLinkIndia" target="_blank" rel="noreferrer" aria-label="YouTube" style={{ width: '32px', height: '32px', borderRadius: '4px', background: '#1E293B', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#FFFFFF' }}>
