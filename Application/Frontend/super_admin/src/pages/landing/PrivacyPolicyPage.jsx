      ...
      <main style={{ paddingTop: '120px', paddingBottom: '80px' }}>
        <div style={{ maxWidth: '960px', margin: '0 auto', padding: '0 24px' }}>
          ...
          <div style={{
            ...
            <p>
              Under DPDP regulations, flat owners and residents retain full control over their personal profile records. You may request profile data correction, access export logs, or submit erasure requests upon moving out of the housing society by contacting your RWA admin or emailing our Data Officer at <a href="mailto:gatelink.in@gmail.com" style={{ color: '#00B589', textDecoration: 'none', fontWeight: 700 }}>gatelink.in@gmail.com</a>.
            </p>
