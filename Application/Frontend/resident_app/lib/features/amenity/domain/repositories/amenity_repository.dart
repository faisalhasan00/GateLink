...
abstract class AmenityRepository {
  ...
  Future<List<String>> getBookedSlotsForDate(String societyId, String amenityId, String date);
  ...
  Future<void> cancelAmenityBooking(String societyId, String bookingId, String uid);
