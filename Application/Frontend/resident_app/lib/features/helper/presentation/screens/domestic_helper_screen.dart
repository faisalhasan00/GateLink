          ...
          children: [
              ...
              data: (helpers) {
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text('No Domestic Helpers Registered',
                              style: TextStyle(
                                  fontSize: 16, fontWeight: FontWeight.bold)),
                          const SizedBox(height: 8),
                          const Text(
                              'Register your maids, drivers, cooks, or caretakers for gate entry verification.',
                ...
                return ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _HelperTile(helper: helper);
                  },
                );
              },
            ...
            helperLogsAsync.when(
              data: (logs) {
                if (logs.isEmpty) {
                  return const Center(
                    child: Text('No helper or delivery entry logs for today.',
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('${helper.type} • ${helper.phone}',
                    style: const TextStyle(
                        fontSize: 12, color: AppColors.textSecondary)),
                const SizedBox(height: 4),
                Text('Schedule: ${helper.workingDays}',
                    style: const TextStyle(
                        fontSize: 11,
                        color: AppColors.textSecondary,
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: helper.isActive
                  ? AppColors.success.withValues(alpha: 0.15)
                  : AppColors.error.withValues(alpha: 0.15),
              borderRadius: BorderRadius.circular(AppRadius.full),
            ),
            child: Text(helper.status.toUpperCase(),
                style: TextStyle(
                    fontSize: 10,
                    fontWeight: FontWeight.w800,
                    color:
                        helper.isActive ? AppColors.success : AppColors.error)),
          ),
        ],
      ),
    );
...
class _HelperLogTile extends StatelessWidget {
  final HelperLogModel log;
  const _HelperLogTile({required this.log});
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('${log.gateName} • ${log.formattedTime}',
                    style: const TextStyle(
