...
abstract class NotificationRepository {
  ...
  Future<void> markNotificationAsRead(String societyId, String notificationId, String uid);
  Future<void> markAllNotificationsAsRead(String societyId, String uid);
  Future<void> deleteNotification(String societyId, String notificationId, String uid);
