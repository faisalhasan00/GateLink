...
class _VisitorTabView extends ConsumerWidget {
                ...
                Row(
                  children: [
                    CircleAvatar(
                      radius: 24,
                      backgroundColor:
                          AppColors.visitor.withValues(alpha: 0.12),
                      child: Text(visitor.initials,
                      ...
                      Expanded(
                        child: OutlinedButton(
                          onPressed: () async {
                            ...
                            if (confirm == true) {
                              final controller =
                                  ref.read(visitorControllerProvider.notifier);
                              final user = ref.read(currentUserProvider);
                              final success =
                                  await controller.updateVisitorApproval(
                              ...
                              if (context.mounted) {
                                if (success) {
                                  ...
                                  final errorMsg = ref
                                          .read(visitorControllerProvider)
                                          .errorMessage ??
                                      'Failed to deny visitor.';
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                ...
                if (visitor.isExpected &&
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton.icon(
                      onPressed: () => _showQrDialog(context, visitor.id,
                          visitor.passCode ?? '100000', visitor.name),
  ...
  void _showQrDialog(BuildContext context, String visitorId, String passCode,
      String visitorName) {
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Entry Pass for $visitorName',
                style: const TextStyle(
                    fontSize: 18,
            ...
            RepaintBoundary(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    QrImageView(
                        data: passCode, version: QrVersions.auto, size: 180),
                    const SizedBox(height: 8),
                    Text('Pass Code: $passCode',
                        style: const TextStyle(
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            letterSpacing: 2)),
