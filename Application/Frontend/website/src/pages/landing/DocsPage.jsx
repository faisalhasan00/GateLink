    ...
    <div style={{ backgroundColor: isDark ? '#0F172A' : '#FFFFFF', color: isDark ? '#FFFFFF' : '#2C2C2C', minHeight: '100vh', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <section style={{ padding: '60px 0 100px 0' }}>
        <div style={{ maxWidth: '1320px', margin: '0 auto', padding: '0 24px', display: 'grid', gridTemplateColumns: '260px 1fr', gap: '40px' }}>
          ...
          {/* Left Docs Nav */}
          <div style={{ background: isDark ? '#1E293B' : '#F8FAFC', padding: '24px', borderRadius: '16px', border: isDark ? '1px solid rgba(255,255,255,0.1)' : '1px solid #E5E7EB', height: 'fit-content' }}>
            <div style={{ fontSize: '12px', fontWeight: 900, color: '#0EA5E9', letterSpacing: '1px', marginBottom: '16px' }}>DOCS NAVIGATION</div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', fontSize: '13px', color: isDark ? '#CBD5E1' : '#444444', fontWeight: 700 }}>
              <a href="#auth" style={{ color: '#1E3A8A', textDecoration: 'none' }}>1. Authentication & Bearer Tokens</a>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
            ...
            {/* Section 1 */}
            <div id="auth" style={{ background: isDark ? '#1E293B' : '#FFFFFF', padding: '32px', borderRadius: '16px', border: isDark ? '1px solid rgba(255,255,255,0.1)' : '1px solid #E5E7EB' }}>
              ...
              <div style={{ background: isDark ? '#0F172A' : '#F1F5F9', padding: '16px', borderRadius: '8px', fontFamily: 'monospace', color: '#0EA5E9', fontSize: '13px', fontWeight: 700 }}>
                Authorization: Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6...
              </div>
            </div>

            {/* Section 2 */}
            <div id="gate-api" style={{ background: isDark ? '#1E293B' : '#FFFFFF', padding: '32px', borderRadius: '16px', border: isDark ? '1px solid rgba(255,255,255,0.1)' : '1px solid #E5E7EB' }}>
              ...
              <div style={{ background: isDark ? '#0F172A' : '#F1F5F9', padding: '16px', borderRadius: '8px', fontFamily: 'monospace', color: '#0EA5E9', fontSize: '13px', marginBottom: '12px', fontWeight: 700 }}>
                POST /api/v1/gate/verify-passcode
              </div>
              <div style={{ background: isDark ? '#0F172A' : '#F1F5F9', padding: '16px', borderRadius: '8px', fontFamily: 'monospace', color: isDark ? '#E2E8F0' : '#333333', fontSize: '13px' }}>
                {`{\n  "passcode": "8492",\n  "gateId": "GATE_01",\n  "guardId": "GUARD_9012"\n}`}
              </div>
            </div>

            {/* Section 3 */}
            <div id="billing-api" style={{ background: isDark ? '#1E293B' : '#FFFFFF', padding: '32px', borderRadius: '16px', border: isDark ? '1px solid rgba(255,255,255,0.1)' : '1px solid #E5E7EB' }}>
