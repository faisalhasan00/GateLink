        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '32px', marginBottom: '48px' }}>
          ...
          <div style={{ gridColumn: 'span 1' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              {/* Instagram */}
              <a href="https://instagram.com" target="_blank" rel="noreferrer" aria-label="Instagram" style={{ width: '32px', height: '32px', borderRadius: '4px', background: '#1E293B', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#FFFFFF' }}>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '9px', fontSize: '13px' }}>
              ...
              <li><Link to="/partners" style={{ color: '#38BDF8', fontWeight: 700, textDecoration: 'none' }}>Partner Program (Earn 2% Lifetime)</Link></li>
